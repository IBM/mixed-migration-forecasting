...
class Scorer(object):
    ...
    def __init__(self, modelfile, config, groupings, baseyear):
        """
        ...
        self.features = Generator(config, groupings, baseyear)

        # Assemble the base scoring feature set
        for m in self.model:
            m['feature'] = self.features.fetch(m['target'], baseyear, m['features'])
    ...
    def __adjust_features(self, Xv, scenario):
        """
    ...
    def predict(self, forecastyear, scenario=None):
        """
