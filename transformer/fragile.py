...
class FragileTransformer(Transformer):
    ...
    def transform_fragile(self):
        ...
        secur_df.loc[:, "Indicator Name"] = "Security Apparatus"
        elite_df.loc[:, "Indicator Code"] = "FSI.FAC.ELI"
        elite_df.loc[:, "Indicator Name"] = "Factionalized Elites"
        group_df.loc[:, "Indicator Code"] = "FSI.GRP.GRI"
        group_df.loc[:, "Indicator Name"] = "Group Grievance"
        econo_df.loc[:, "Indicator Code"] = "FSI.ECON"
        econo_df.loc[:, "Indicator Name"] = "Economy"
        ineq_df.loc[:, "Indicator Code"] = "FSI.ECON.INQ"
        ineq_df.loc[:, "Indicator Name"] = "Economic Inequality"
        flight_df.loc[:, "Indicator Code"] = "FSI.HMN.FLI"
        flight_df.loc[:, "Indicator Name"] = "Human Flight and Brain Drain"
        state_df.loc[:, "Indicator Code"] = "FSI.STA.LEG"
        state_df.loc[:, "Indicator Name"] = "State Legitimacy"
        public_df.loc[:, "Indicator Code"] = "FSI.PUB.SER"
        public_df.loc[:, "Indicator Name"] = "Public Services"
        rights_df.loc[:, "Indicator Code"] = "FSI.HMN.RIG"
        rights_df.loc[:, "Indicator Name"] = "Human Rights"
        demog_df.loc[:, "Indicator Code"] = "FSI.DEM.PRS"
        demog_df.loc[:, "Indicator Name"] = "Demographic Pressures"
        refug_df.loc[:, "Indicator Code"] = "FSI.REF.IDP"
        refug_df.loc[:, "Indicator Name"] = "Refugees and IDPs"
        inter_df.loc[:, "Indicator Code"] = "FSI.EXT.INT"
        inter_df.loc[:, "Indicator Name"] = "External Intervention"
