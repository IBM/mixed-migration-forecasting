...
class UCDPTransformer(Transformer):
    ...
    def transform_ucdp(self):
        ...
        self.ucdp_df = events_df.append(state_based_df, sort="True").append(nonstate_df, sort="True").append(one_sided_df, sort="True").append(events_fatal, sort="True").append(state_based_fatal, sort="True").append(nonstate_fatal, sort="True").append(one_sided_fatal, sort="True")
